export const posts =
    {
        recieved: [
            ...
            {username: 'vlogger_mommy1023', post: 'Hey everyone! Just released a new video: PRANKED MY NEWBORN | SHE CRIED! on my YT. Support me in the comments :D'},
            ...
            {username: 'lorne_a_20014', post: '36m nashville'},
            {username: 'john', post: 'hello . i m not sure what this is'}, 
            {username: 'iHAT3thisWebs1t3', post:'Does anyone else hate this egg website'},
            {username: 'Tro113rgal', post: 'Agreed, not enough egg puns'},
            {username: 'egg__enthusiast989', post: '^ You mean Eggreed'},
            {username: 'Troll3rgal', post: 'I said what I said'},
            {username: 'lorne_a_20014', post: '@)-,--'}
        ],
        sent: ['']
    } 